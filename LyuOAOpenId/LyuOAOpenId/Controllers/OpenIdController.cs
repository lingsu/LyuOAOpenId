    ...
    public class OpenIdController : Controller
    {
		...
		public ActionResult SendAssertion()
        {
            ...
            if (authReq != null && authReq.IsAuthenticated.Value)
            {
                ...
                {
                    authReq.LocalIdentifier = Infrastructure.User.GetClaimedIdentifierForUser(User.Identity.Name);
                }
        ...
        private bool UserControlsIdentifier(IAuthenticationRequest authReq)
        {
            ...
            Uri userLocalIdentifier = Infrastructure.User.GetClaimedIdentifierForUser(User.Identity.Name);
